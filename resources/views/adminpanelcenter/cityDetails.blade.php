...
@section('content')
    <div class="content">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form action="{{route('cities.store')}}" enctype="multipart/form-data" method="post">
                            ...
                            <div class="form-group">
                                <label for="exampleFormControlFile1">upload one or multiple files</label>
        ...
        <div class="card">
            <div class="card-header">
                <h3>The images related to the city : {{$city->name}}</h3>
                <div class="row">
                    @foreach ($images as $image)
                        <div class="col-md-4">
                            <div>
                                <img src="{{ asset('storage/'.$image->imageurl) }}" alt="{{$city->name}}" class="img-thumbnail mt-5" style="width: 400px;height: 400px" >
                                <a class="text-danger" href="#"><i class="fas fa-trash fa-2x"></i></a>
                            </div>
