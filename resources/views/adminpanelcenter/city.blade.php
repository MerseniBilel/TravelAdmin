                ...
                <div class="card">
                    ...
                    <form action="{{route('cities.store')}}" enctype="multipart/form-data" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input required type="file" class="form-control-file" id="exampleFormControlFile1" name="images[]" multiple>
                            </div>
                    ...
                    <table class="table table-head-bg-success">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" data-toggle="modal" data-target="#exampleModal"><i class="fas fa-trash-alt text-danger m-2"></i></a>
                                <a href="{{route('cities.show', $cities->id)}}"><i class="far fa-edit text-warning"></i></a>
                                </td> 
                        ...
                        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    CONFIRM THE DELETE OF THIS CITY ?
                                </div>
